...
public class ModLangProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("jei.cybercultivator.atmospheric_condensing", "大气冷凝");
        ...
        add("jei.cybercultivator.incubator.summary", "默认 S%s Y%s P%s · 产出 ×%s");
        ...
        // 机器 GUI
        add("container.cybercultivator.bio_incubator", "生物培养槽");
        add("container.cybercultivator.gene_splicer", "基因拼接机");
        add("container.cybercultivator.serum_bottler", "血清灌装机");
        add("container.cybercultivator.atmospheric_condenser", "大气冷凝器");
        add("gui.cybercultivator.eta", "预计 %s 秒");
        add("gui.cybercultivator.waiting", "等待资源");
        add("gui.cybercultivator.splicer.parent_a", "A");
        add("gui.cybercultivator.splicer.parent_b", "B");
        add("gui.cybercultivator.splicer.offspring", "子代");
        add("gui.cybercultivator.splicer.status_waiting_two", "放入两颗基因种子");
        add("gui.cybercultivator.splicer.status_waiting_one", "还需一颗基因种子");
        add("gui.cybercultivator.splicer.status_ready", "正在启动拼接");
